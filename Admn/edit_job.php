...
<html lang="en">
 ...
 <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
  ...
  <meta name="request-id" content="EB3D:50E7:6C2875:BC620C:5C002888" data-pjax-transient>
  ...
  <meta name="octolytics-host" content="collector.githubapp.com" /><meta name="octolytics-app-id" content="github" /><meta name="octolytics-event-url" content="https://collector.githubapp.com/github-external/browser_event" /><meta name="octolytics-dimension-request_id" content="EB3D:50E7:6C2875:BC620C:5C002888" /><meta name="octolytics-dimension-region_edge" content="iad" /><meta name="octolytics-dimension-region_render" content="iad" />
...
<meta class="js-ga-set" name="dimension1" content="Logged Out">
    ...
    <meta name="js-proxy-site-detection-payload" content="MDg3ODc0NDIxMGI2ZTQyMjg0NmEwZjUyM2RkYjE0MTliZjE4OWQwOTY2ODMxM2YxMDRiZDQ3MmVmODE2NGE0NHx7InJlbW90ZV9hZGRyZXNzIjoiMTAzLjU1LjYwLjg2IiwicmVxdWVzdF9pZCI6IkVCM0Q6NTBFNzo2QzI4NzU6QkM2MjBDOjVDMDAyODg4IiwidGltZXN0YW1wIjoxNTQzNTE0MjUwLCJob3N0IjoiZ2l0aHViLmNvbSJ9">

    <meta name="enabled-features" content="DASHBOARD_V2_LAYOUT_OPT_IN,EXPLORE_DISCOVER_REPOSITORIES,UNIVERSE_BANNER,MARKETPLACE_PLAN_RESTRICTION_EDITOR">

  <meta name="html-safe-nonce" content="34b6536f9a23ed115bc31fcab4b5c72700869bf7">
...
include('../include/mydb.php');
  $job_id = $_GET['job_id'];
  $qry = "SELECT `enter_job_title`, `Job_profile`, `job_type`, `job__description`, `job_location`, `enter_job_image` FROM `admin_enter_job` where job_id=$job_id";
...
?>
      ...
      <div class="auth-form-body mt-3">
        ...
        <input  value="<?php echo $data['enter_job_title']; ?>"  type="text" name="food_title" id="login_field" class="form-control input-block" tabindex="1" autocapitalize="off" autocorrect="off" autofocus="autofocus" />
           <label for="login_field">
          Food Name
        </label>
        <input type="text" value="<?php echo $data['Job_profile']; ?>" name="food_name" id="login_field" class="form-control input-block" tabindex="1" autocapitalize="off" autocorrect="off" autofocus="autofocus" />
           <label for="login_field">
          Food Type
        </label>
        <input type="text"  value="<?php echo $data['job_type']; ?>"  name="food_type" id="login_field" class="form-control input-block" tabindex="1" autocapitalize="off" autocorrect="off" autofocus="autofocus" />
           <label for="login_field">
          Food Description
        </label>
        <input type="text"  value="<?php echo $data['job__description']; ?>" name="food_des" id="login_field" class="form-control input-block" tabindex="1" autocapitalize="off" autocorrect="off" autofocus="autofocus" />
      <label for="login_field">
          Food Price
        </label>
        <input type="text"  value="<?php echo $data['job_location']; ?>" name="food_rent" id="login_field" class="form-control input-block" tabindex="1" autocapitalize="off" autocorrect="off" autofocus="autofocus" />
              <label for="login_field">
          Food Image
        </label>
        <input type="file"  value="<?php echo $data['enter_job_image']; ?>"  name="food_image" id="login_field" class="form-control input-block" tabindex="1" autocapitalize="off" autocorrect="off" autofocus="autofocus" />
        <!-- <span><?php echo $data['enter_food_image']?></span> -->
<input type="submit" name="job_update" value="Update" tabindex="3" class="btn btn-primary btn-block"  />
            </form>
...
$qry = "UPDATE `admin_enter_job` SET `enter_job_title`= '$job_title',`Job_profile`='$job_pro,`job_type`='$job_type',
`job__description`= '$job_des',
`job_location`= '$job_loca',`enter_job_image`='$job_img' where `job_id`='$job_id'";
      ...
      <script>
       ...
       window.open('edit_food.php', '_self');
      </script>
      <?php
