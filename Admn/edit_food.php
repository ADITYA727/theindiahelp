...
include('../include/mydb.php');
  ...
  $qry = "SELECT enter_food_title,food_name,food_type,food_provider,food_rs,enter_food_image FROM `admin_enter_food` where food_id=$food_id";
...
?>
      ...
      <div class="auth-form-body mt-3">
        ...
        <input  value="<?php echo $data['enter_food_title']; ?>"  type="text" name="food_title" id="login_field" class="form-control input-block" tabindex="1" autocapitalize="off" autocorrect="off" autofocus="autofocus" />
           <label for="login_field">
          Food Name
        </label>
        <input type="text" value="<?php echo $data['food_name']; ?>" name="food_name" id="login_field" class="form-control input-block" tabindex="1" autocapitalize="off" autocorrect="off" autofocus="autofocus" />
           <label for="login_field">
          Food Type
        </label>
        <input type="text"  value="<?php echo $data['food_type']; ?>"  name="food_type" id="login_field" class="form-control input-block" tabindex="1" autocapitalize="off" autocorrect="off" autofocus="autofocus" />
           <label for="login_field">
          Food Description
        </label>
        <input type="text"  value="<?php echo $data['food_provider']; ?>" name="food_des" id="login_field" class="form-control input-block" tabindex="1" autocapitalize="off" autocorrect="off" autofocus="autofocus" />
      <label for="login_field">
          Food Price
        </label>
        <input type="number"  value="<?php echo $data['food_rs']; ?>" name="food_rent" id="login_field" class="form-control input-block" tabindex="1" autocapitalize="off" autocorrect="off" autofocus="autofocus" />
              <label for="login_field">
          Food Image
        </label>
        <input type="file"  value="<?php echo $data['enter_food_image']; ?>"  name="food_image" id="login_field" class="form-control input-block" tabindex="1" autocapitalize="off" autocorrect="off" autofocus="autofocus" />
        <!-- <span><?php echo $data['enter_food_image']?></span> -->
<input type="submit" name="food_update" value="Update" tabindex="3" class="btn btn-primary btn-block"  />
...
$qry = "update `admin_enter_food` set `enter_food_title`='$food_title' , `food_name`='$food_name' ,`food_type`='$food_type' , `food_provider`='$food_des' , `food_rs`='$food_rs' , `enter_food_image`='$food_img' where `food_id`='$food_id'";
