...
<section id="body-container">
    ...
    <form class="searchmain" id="searchmain" method="POST" action="job.php">
 ...
 <?php
  ...
  <br>
    ...
    <div class="container">
        ...
        $qry="SELECT `enter_job_title`, `Job_profile`, `job_type`, `job__description`, `job_location`, `enter_job_image`,       `created_on`  FROM `admin_enter_job` order by created_on DESC LIMIT 9";
